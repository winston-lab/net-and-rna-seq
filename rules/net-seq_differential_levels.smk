...
rule call_diffexp_transcripts:
    ...
    output:
        results_all = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-all.tsv",
        results_up = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-up.tsv",
        results_down = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-down.tsv",
        results_unch = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-unch.tsv",
        bed_all = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-all.bed",
        bed_up = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-up.bed",
        bed_down = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-down.bed",
        bed_unch = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-results-{norm}-unch.bed",
        normcounts = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-counts-sfnorm-{norm}.tsv",
        rldcounts = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-counts-rlog-{norm}.tsv",
        qcplots = "diff_exp/{condition}-v-{control}/{condition}-v-{control}-{assay}-qcplots-{norm}.svg"
    params:
