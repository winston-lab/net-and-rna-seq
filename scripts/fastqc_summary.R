...
main = function(seq_len_dist_in, per_tile_in, per_base_qual_in,
    ...
    ggsave(per_base_qual_out, plot=per_base_qual_plot, width=26, height=4+1.5*nsamples, units="cm")
    ...
    ggsave(adapter_content_out, plot=adapter_plot, width=26, height=4+1.5*nsamples, units="cm")
    ...
    ggsave(per_base_seq_out, plot=per_base_seq_plot, width=26, height=4+2.5*nsamples, units="cm")
    ...
    ggsave(per_seq_qual_out, plot=per_seq_qual_plot, width=26, height=2+2*nsamples, units="cm")
    ...
    ggsave(seq_dup_out, plot=dup_level_plot, width=26, height=2+2.25*nsamples, units="cm")
